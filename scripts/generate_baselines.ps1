...
& "D:\GIT\farcry\Cursor\FKmermaid\src\powershell\generate_erd_domain_colors.ps1" -lFocus "partner,member" -DiagramType "ER" -lDomains "provider" -OutputFile "baseline_partner_member_focus_provider_domain_er.mmd"
...
& "D:\GIT\farcry\Cursor\FKmermaid\src\powershell\generate_erd_domain_colors.ps1" -lFocus "programme,activityDef" -DiagramType "ER" -lDomains "pathway" -OutputFile "baseline_programme_activity_focus_pathway_domain_er.mmd"
...
& "D:\GIT\farcry\Cursor\FKmermaid\src\powershell\generate_erd_domain_colors.ps1" -lFocus "partner" -DiagramType "ER" -lDomains "provider,pathway" -OutputFile "baseline_partner_focus_provider_pathway_domains_er.mmd"

# Test case 4: Class diagram test
Write-Host "📊 Generating baseline 4: Class diagram test" -ForegroundColor Yellow
& "D:\GIT\farcry\Cursor\FKmermaid\src\powershell\generate_erd_domain_colors.ps1" -lFocus "partner" -DiagramType "Class" -lDomains "provider" -OutputFile "baseline_partner_focus_provider_domain_class.mmd"

# Test case 5: All domains test
Write-Host "📊 Generating baseline 5: All domains test" -ForegroundColor Yellow
& "D:\GIT\farcry\Cursor\FKmermaid\src\powershell\generate_erd_domain_colors.ps1" -lFocus "member" -DiagramType "ER" -lDomains "all" -OutputFile "baseline_member_focus_all_domains_er.mmd"
